...
def train():
    ...
    learning_rate = 6e-4  # 稍微调高初始 LR，依靠调度器控制
    max_iters = 5000      # 我们改用迭代次数控制，而不是 Epoch，这样更直观
    eval_interval = 500
    ...
    # 简单的划分逻辑 (确保 dataset 支持切片或有 split 方法)
    # 这里沿用你之前的逻辑，但在 loader 中设置 num_workers=0 以兼容 Windows
